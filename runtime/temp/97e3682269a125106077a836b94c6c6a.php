...
<div class="main-title">
    <h2><?php echo isset($info['id'])?'编辑':'新增'; ?>报修</h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">联系方式<span class="check-tips">（联系电话）</span></label>
        <div class="controls">
    ...
    <div class="form-item">
        <label class="item-label">报修详情<span class="check-tips">（详细描述报修内容）</span></label>
        <div class="controls">
...
<script type="text/javascript">
    ...
    //导航高亮
    highlight_subnav('<?php echo url('RealEstate/index'); ?>');
</script>
