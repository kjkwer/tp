<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"F:\www\tp\public/../application/admin/view/default/rent_sell\edit.html";i:1512059945;s:67:"F:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <select name="genre">
                <option value="1" <?php if($info['genre']==1): ?> selected <?php endif; ?>>万元</option>
                <option value="2" <?php if($info['genre']==2): ?> selected <?php endif; ?>>/月</option>
            </select>
        </div>
    </div>
    <div class="form-item">
        ...
        <div class="controls">
            <select name="type" value="<?php echo (isset($info['type']) && ($info['type'] !== '')?$info['type']:""); ?>">
                <option value="1" <?php if($info['type']==1): ?> selected <?php endif; ?>>出租</option>
                <option value="2" <?php if($info['type']==2): ?> selected <?php endif; ?>>出售</option>
            </select>
        </div>
    </div>
    ...
    <div class="controls">
        ...
        <input type="hidden" name="cover_id" id="cover_id_cover_id" value="<?php echo (isset($info['cover_id']) && ($info['cover_id'] !== '')?$info['cover_id']:""); ?>"/>
        ...
        <div class="upload-img-box">
            ...
            <div class="upload-pre-item"><img src="<?php echo get_cover($info['cover_id'],'path'); ?>" width="200px"/></div>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <textarea name="desc" id="" cols="50" rows="10"><?php echo (isset($info['desc']) && ($info['desc'] !== '')?$info['desc']:''); ?></textarea>
        </div>
    </div>
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" name="deadline" class="text date" value="<?php echo (isset($info['deadline']) && ($info['deadline'] !== '')?$info['deadline']:""); ?>" placeholder="请选择日期" />
        </div>
    </div>
