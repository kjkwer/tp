<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"F:\www\tp\public/../application/home/view/default/article\lists.html";i:1511939745;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="utf-8">
            ...
            if (data.length != 0){
                $.each(data,function () {
                    ...
                    $.post("/home/inform/message",{"cover_id":this.cover_id,"update_time":this.update_time},function (data) {
                        ...
                        var str = '<div class="row noticeList"> <a href="/home/article/detail/id/'+that.id+'.html"> <div class="col-xs-2"> <img class="noticeImg" src="'+cover+'" alt="加载失败"/> </div> <div class="col-xs-10"> <p class="title">'+that.title+'</p> <p class="intro">'+that.description+'</p> <p class="info">浏览: '+that.view+' <span class="pull-right">'+time+'</span> </p> </div> </a> </div>'
                        $("#inform").append(str);
                    })
                })
            }else {
