<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"F:\www\tp\public/../application/admin/view/default/rent_sell\index.html";i:1512061479;s:67:"F:\www\tp\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
    <a class="btn" href="<?php echo url('rentSell/add'); ?>">新 增</a>
    <button class="btn ajax-post confirm" url="<?php echo url('del'); ?>" target-form="ids">删 除</button>
    <button class="btn ajax-post" target-form="ids" url="<?php echo url('forbidden'); ?>" target-form="ids">禁  用</button>
    <button class="btn ajax-post" target-form="ids" url="<?php echo url('start'); ?>" target-form="ids">启  用</button>
    ...
    <form class="ids">
        <table>
            ...
            <tr>
                ...
                <td><?php echo get_username($list['uid']); ?></td>
                ...
                <td><?php echo $list['price']; if($list['genre']==1): ?>
                    <span>万元</span>
                    <?php else: ?>
                    <span>/月</span>
                    <?php endif; ?>
                </td>
                <td><?php echo time_format($list['create_time']); ?></td>
                <td><?php echo time_format($list['deadline']); ?></td>
                <td>
                ...
                <td>
                    <?php if($list['status']==1): ?>
                    <a class="confirm ajax-get" title="删除" href="<?php echo url('forbidden?id='.$list['id']); ?>">禁用</a>
                    <?php else: ?>
                    <a class="confirm ajax-get" title="删除" href="<?php echo url('start?id='.$list['id']); ?>">启用</a>
                    <?php endif; ?>
                    <a title="编辑" href="<?php echo url('edit?id='.$list['id']); ?>">编辑</a>
                    <a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$list['id']); ?>">删除</a>
                </td>
            </tr>
