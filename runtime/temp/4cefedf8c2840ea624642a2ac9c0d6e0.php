<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"F:\www\tp\public/../application/user/view/default/login\auth.html";i:1512023152;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container">
        ...
        <form class="form-signin login-form" action="/User/login/auth" method="post">
