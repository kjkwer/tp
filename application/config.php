...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'uMDX6{7}UPxW#sR[Tef(4$SCg?.<aFlIkQ*,]38;', //默认数据加密KEY
	'data_cache_key'=> 'uMDX6{7}UPxW#sR[Tef(4$SCg?.<aFlIkQ*,]38;',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'uMDX6{7}UPxW#sR[Tef(4$SCg?.<aFlIkQ*,]38;', //加密KEY
